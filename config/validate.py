...
class ValidateNotebook:
    def __init__(
        ...
        self.lifecycle_config_name = str(file_config["id"]) + file_config["filename"].replace(".ipynb", "")
        self.notebook_instance_name = str(file_config["id"]) + file_config["filename"].replace(".ipynb", "")
